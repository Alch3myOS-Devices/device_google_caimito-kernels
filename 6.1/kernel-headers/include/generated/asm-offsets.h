...
#define THREAD_SCTLR_USER 4736 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4632 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4712 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4728 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 2520 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2464 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_cpu_context, regs) */
#define CPU_ELR_EL2 1976 /* offsetof(struct kvm_cpu_context, sys_regs[ELR_EL2]) */
...
#define HOST_CONTEXT_VCPU 2168 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
